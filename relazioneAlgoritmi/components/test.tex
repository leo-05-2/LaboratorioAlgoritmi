...
di seguito sono descritti i test e i risultati ottenuti, con relativi andamenti sia singolarmente che comparativi.
\\
...
- \textbf{LinkedList e BSTree}: Come previsto dalla teoria, entrambe le strutture mostrano un tempo di esecuzione che cresce linearmente (O(n)) con la dimensione dell'input. Le loro curve di performance sono quasi sovrapponibili, con il BSTree che mostra una costante leggermente più alta (pendenza maggiore) a causa dell'overhead della gestione della struttura ad albero rispetto alla semplice iterazione della lista.
...
\begin{figure}[H]
  \centering
\begin{minipage}{\textwidth}\centering
  \includegraphics[width=\linewidth]{../src/png/rank_performance_LinkedList}
...
\begin{figure}[H]
  \centering
\begin{minipage}{\textwidth}\centering
  \includegraphics[width=\linewidth]{../src/png/select_performance_LinkedList}
...
\begin{figure}[H]
  \centering
\begin{minipage}{\textwidth}\centering
  \includegraphics[width=\linewidth]{../src/png/rank_performance_BSTree}
...
\begin{figure}[H]
  \centering
\begin{minipage}{\textwidth}\centering
  \includegraphics[width=\linewidth]{../src/png/select_performance_BSTree}
...
\begin{figure}[H]
  \centering
\begin{minipage}{\textwidth}\centering
  \includegraphics[width=\linewidth]{../src/png/rank_performance_SBStree}
...
\begin{figure}[H]
  \centering
\begin{minipage}{\textwidth}\centering
  \includegraphics[width=\linewidth]{../src/png/select_performance_SBStree}
...
\begin{figure}[H]
  \centering
\begin{minipage}{\textwidth}\centering
  \includegraphics[width=\linewidth]{../src/png/rank_performance}
...
\begin{figure}[H]
  \centering
\begin{minipage}{\textwidth}\centering
  \includegraphics[width=\linewidth]{../src/png/select_performance}
...
\\
\textbf{LinkedList e BSTree}: In questo scenario, il `BSTree` degenera in una lista.\\
