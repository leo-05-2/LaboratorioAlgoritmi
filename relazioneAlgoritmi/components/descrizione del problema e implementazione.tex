...
La classe \texttt{SBSTree} implementa basato su una struttura \textbf{AVL (Albero Autobilanciato)}. Questa implementazione combina due proprietà fondamentali per garantire operazioni efficienti:
